...
export const LoginResponse = zod.object({
  ...
  "app_metadata": zod.record(zod.string(), zod.unknown()).optional(),
  "user_metadata": zod.record(zod.string(), zod.unknown()).optional()
}).optional(),
  "weak_session": zod.boolean(),
  "factors": zod.array(zod.object({
  "id": zod.string(),
  "factor_type": zod.string(),
  "status": zod.string()
})),
 ...
 */
export const GetUserBody = zod.object({
 ...
 */
export const ListRagDocumentsResponse = zod.object({
...
export const GetRagStatusResponse = zod.object({
  ...
  "chunks": zod.number(),
  "readerOk": zod.boolean(),
  "embedOk": zod.boolean(),
  "generation": zod.string().nullish(),
  "store": zod.enum(['pgvector', 'memory'])
})
 ...
 */
export const ReingestResponse = zod.object({
  "configured": zod.boolean(),
  "live": zod.boolean(),
  "documents": zod.array(zod.string()),
  "chunks": zod.number(),
 ...
 */
export const SearchRagBody = zod.object({
  "query": zod.string()
})

export const SearchRagResponse = zod.object({
  "answer": zod.string(),
 ...
 */
export const ChatRagBody = zod.object({
  "question": zod.string(),
...
export const ChatRagResponse = zod.object({
  "answer": zod.string(),
  "confidence": zod.number(),
  "citations": zod.array(zod.object({
  "document": zod.string(),
 ...
 */
export const SyncRagStorageResponse = zod.object({
  "scanned": zod.number(),
  "indexed": zod.number(),
  "updated": zod.number(),
  "removed": zod.number(),
 ...
 */
export const ListJiraTicketsResponse = zod.object({
  ...
  "status": zod.string(),
  "assignee": zod.string(),
  "environment": zod.enum(['SIT', 'UAT', 'STAGING', 'PROD']),
  "updatedAt": zod.string()
})),
  "source": zod.string(),
 ...
 */
export const ListVendorSubmissionsResponse = zod.object({
  "submissions": zod.array(zod.object({
  "vendorId": zod.string(),
  "type": zod.enum(['invoice', 'delivery', 'milestone', 'po_acceptance']),
  "poNumber": zod.string(),
  "amount": zod.number(),
  "submittedAt": zod.string()
})),
  "source": zod.enum(['vendor-api', 'representative']),
  "degraded": zod.boolean().optional(),
  "message": zod.string().optional()
})
 ...
 */
export const importBudgetBodyRowsMax = 200;



export const ImportBudgetBody = zod.object({
  "rows": zod.array(zod.object({
  "fiscalYear": zod.number(),
  "category": zod.string(),
  "allocated": zod.number(),
  "incurred": zod.number().optional()
})).min(1).max(importBudgetBodyRowsMax)
})

export const ImportBudgetResponse = zod.object({
  "imported": zod.number(),
  "updated": zod.number(),
